...
if __name__ == '__main__':
    ...
    arg_parse.add_argument('-r', '--build-reserve', action='store_true',
                           help='build reserve routes')
    arg_parse.add_argument('-s', '--source-node-id',
                           help='source node id to visualize')
    arg_parse.add_argument('-d', '--destination-node-id',
